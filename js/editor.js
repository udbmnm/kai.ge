 ...
 */
function drawImage(editor,src) {
  var cm = editor.codemirror;
  var stat = getState(cm);
  _replaceSelection(cm, stat.image, '![', '](http://'+(src || '')+')');
}
...
Editor.prototype.drawImage = function(src) {
  drawImage(this,src);
};
